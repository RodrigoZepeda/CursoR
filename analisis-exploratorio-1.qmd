...
#| echo: false
#| output: asis
# Este archivo está en WINDOWS-1252 y aquí lo leemos A PROPÓSITO sin declararlo,
# para mostrar cómo se ven los acentos cuando la codificación no coincide. El
# iconv con sub = "?" reproduce ese efecto de forma idéntica en cualquier
# computadora (si no, el resultado dependería del idioma del sistema de quien lea).
# El archivo está en WINDOWS-1252; al interpretarlo como UTF-8 sus bytes de
# acentos son inválidos, y sub = "?" los sustituye por el signo de interrogación.
zapopan_crudo <- read_lines("datasets/zapopan.csv", n_max = 5)
cat(iconv(zapopan_crudo, from = "UTF-8", to = "UTF-8", sub = "?"), sep = "\n")
```
