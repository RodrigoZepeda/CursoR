...
author: "Rodrigo Zepeda y Rossan Torres"
date: "`r Sys.Date()`"
output:
  tufte::tufte_html: 
...
knitr::include_graphics('images/Softdrinks.jpg')
```

3. Al agregar la siguiente línea al código nos aparecen los siguientes mensajes:
...
2. Obtén un arreglo de gráficas que se vea así:

```{r,  cache=TRUE, echo = FALSE,  message=FALSE}
knitr::include_graphics('images/Arreglo_depresión.jpg')
```
