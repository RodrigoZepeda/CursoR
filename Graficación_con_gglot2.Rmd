...
> **DATOS** Todos los datos discutidos aquí se encuentran en la siguiente liga: [https://github.com/RodrigoZepeda/CursoR/tree/master/datasets](https://github.com/RodrigoZepeda/CursoR/tree/master/datasets). Para descargarlos dar clic sobre el nombre de la base, y luego clic derecho en `Raw` y `Guardar vínculo como`.
