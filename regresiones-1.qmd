...
tibble(
  ...
  geom_point(aes(x = 10, y = 35),
    color = "#ff6361", size = 3,
    data = NULL
  ) +
  geom_point(aes(x = 15, y = 50),
    color = "#ff6361", size = 3,
    data = NULL
  ) +
  labs(
...
tibble(
  ...
  theme_bw() +
  geom_line(aes(y = x, x = 3 * x + 5),
    data = tibble(x = c(0, 5, 10, 15)),
    color = "#58508d", linewidth = 1
  ) +
  geom_point(aes(y = x, x = 3 * x + 5),
    data = tibble(x = c(0, 5, 10, 15)),
    color = "#58508d", size = 3
  ) +
  geom_point(aes(y = x, x = 3 * x + 5),
...
ggplot(datos_bien) +
  ...
  geom_segment(
    aes(
      x = 12, xend = as.numeric(datos_bien[50, "x"]),
  ...
  geom_segment(
    aes(
      x = 3, xend = as.numeric(datos_bien[12, "x"]),
...
ggplot(datos_bien) +
  geom_point(aes(x = x, y = y), color = "#003f5c", size = 2) +
  geom_smooth(aes(x = x, y = y, color = "Sin el normal"),
    method = "lm",
    formula = y ~ x, se = F, data = datos_bien[-12, ]
  ) +
  geom_smooth(aes(x = x, y = y, color = "Sin el influyente"),
    method = "lm",
    formula = y ~ x, se = F, data = datos_bien[-50, ]
  ) +
  geom_smooth(aes(x = x, y = y, color = "Todos los datos"),
    method = "lm",
    formula = y ~ x, se = F
  ) +
  theme_bw() +
